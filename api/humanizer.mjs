...
const systemInstruction = `Rewrite the text from the perspective of an academic dictating their fresh research thoughts aloud, maintaining strict professional vocabulary without conversational filler.
